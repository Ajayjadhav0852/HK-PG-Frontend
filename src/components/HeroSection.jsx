...
function BookVisitModal({ onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Send WhatsApp message to owner with visitor details
    ...
    // Open WhatsApp in background (non-blocking)
          ...
          {done ? (
            <div style={{ textAlign: 'center', padding: '16px 0' }}>
              <div style={{ fontSize: 52, marginBottom: 12 }}>
                <svg viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="56" height="56" style={{ margin: '0 auto', display: 'block' }}>
              ...
              <p style={{ color: '#6b7280', fontSize: 14, margin: '0 0 20px', lineHeight: 1.6 }}>
                The owner has been notified via WhatsApp. You'll receive a call shortly to schedule your visit.
              </p>
              <button onClick={onClose} style={{
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  {VISITOR_TYPES.map(t => (
                    <button
                      ...
                      style={{
                        ...
                        background: form.type === t.key ? 'linear-gradient(135deg,#d63384,#c026d3)' : 'white',
                        color: form.type === t.key ? 'white' : '#374151',
                        border: form.type === t.key ? 'none' : '1.5px solid #e5e7eb',
                        boxShadow: form.type === t.key ? '0 4px 12px rgba(208,35,132,0.3)' : 'none',
                      }}
                    >
                      {t.label}
                    </button>
              ...
              {error && (
                <p style={{ color: '#dc2626', fontSize: 13, background: '#fef2f2', padding: '10px 14px', borderRadius: 10, margin: 0 }}>
                  {error}
                </p>
              )}
              ...
              <button type="submit" disabled={loading} style={{
                ...
                background: loading ? '#e5e7eb' : 'linear-gradient(135deg,#d63384,#c026d3)',
              ...
              <p style={{ color: '#9ca3af', fontSize: 11, textAlign: 'center', margin: 0 }}>
                Owner will contact you within a few hours to confirm your visit.
              </p>
            </form>
          )}
        </div>
    ...
    <>
      ...
      <div className="relative w-full overflow-hidden" style={{ height: '90vh', minHeight: '560px' }}>
        ...
        <div className="absolute top-1/3 left-0 right-0 px-6 sm:px-12 lg:px-20">
          ...
          <h1 className="font-extrabold leading-tight" style={{ fontSize: 'clamp(3rem, 8vw, 6rem)', color: '#f472b6' }}>
            Accommodation
          </h1>
          ...
          <div className="mt-6 flex gap-3 flex-wrap">
            ...
            <button
              ...
              className="px-6 py-3 rounded-xl font-bold transition hover:bg-white/30"
              style={{
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            {[
              ...
              { icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5"><path d="M12 2C6 9 4 13 4 16a8 8 0 0 0 16 0c0-3-2-7-8-14z"/></svg>, label: 'RO Water' },
