        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-extrabold text-gray-800 text-base">
              Well Connected to IT Hubs & Offices
            </h3>
          </div>
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span
                key={i}
                className="inline-flex items-center gap-1.5 bg-purple-50 border border-purple-200 text-purple-700 text-xs font-semibold px-3 py-1.5 rounded-full hover:bg-purple-100 transition-all cursor-default"
              >
                {hub.type === 'train' ? (
          ...
          <div className="flex items-center gap-1.5 mt-3">
            ...
            <p className="text-xs text-gray-400">
              Near Akurdi Railway Station — easy commute to all major IT hubs across Pune & PCMC
            </p>
          </div>
        </div>
